...
class SigningCosmWasmClient extends cosmwasmclient_1.CosmWasmClient {
    ...
    async calculateFeeForTransaction(signerAddress, messages, memo, fee) {
        ...
        if ((0, stargate_1.isDynamicGasPriceConfig)(gasPriceConfig)) {
            ...
            try {
                ...
                const dynamicGasPriceDecimal = await (0, stargate_1.queryDynamicGasPrice)(queryClient, dynamicGasConfig.denom, chainId);
                // Multiply by multiplier 18 fractional digits for Dec type
                const fractionalDigits = minGasPrice.amount.fractionalDigits;
                const adjustedGasPrice = (0, stargate_1.multiplyDecimalByNumber)(dynamicGasPriceDecimal, multiplierValue, fractionalDigits);
                ...
                const dynamicGasPriceObj = new stargate_1.GasPrice(finalGasPrice, dynamicGasConfig.denom);
                return (0, stargate_1.calculateFee)(gasLimit, dynamicGasPriceObj);
            }
            catch (_error) {
                // Fallback to minGasPrice if query fails
                return (0, stargate_1.calculateFee)(gasLimit, minGasPrice);
            }
        }
        else {
            // Static gas price
            (0, utils_1.assert)(gasPriceConfig instanceof stargate_1.GasPrice, "Gas price must be a GasPrice instance when using static pricing.");
            return (0, stargate_1.calculateFee)(gasLimit, gasPriceConfig);
        }
    }

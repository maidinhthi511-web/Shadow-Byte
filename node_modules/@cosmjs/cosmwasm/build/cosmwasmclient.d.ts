import { Account, AccountParser, AuthExtension, BankExtension, Block, Coin, DeliverTxResponse, IndexedTx, QueryClient, SearchTxQuery, SequenceResponse, TxExtension } from "@cosmjs/stargate";
...
export declare class CosmWasmClient {
     ...
     */
    static connect(endpoint: string | HttpEndpoint, options?: CosmWasmClientOptions): Promise<CosmWasmClient>;
    /**
     * Creates an instance from a manually created Comet client.
     * Use this to use `Comet38Client` or `Tendermint37Client` instead of
     * auto-detection.
     */
    static create(cometClient: CometClient, options?: CosmWasmClientOptions): CosmWasmClient;

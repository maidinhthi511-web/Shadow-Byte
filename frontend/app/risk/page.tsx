    ...
    <main className="p-8 max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 border rounded">
          <label className="block text-sm">Collateral Value</label>
          ...
          <label className="block text-sm mt-3">Loan Amount</label>
        ...
        <div className="p-4 border rounded">
          <label className="block text-sm">Simulate Price Drop ({dropPercent}%)</label>
          ...
          <div className="mt-4">
            ...
            {currentLtv > 80 && <p className="text-red-600 mt-2">ALERT: LTV exceeded 80% — liquidation triggered</p>}
          </div>
        </div>
      </div>
    </main>
